...
void solve()
{
    ...
    FOR(i,2*n)
    {
        it = std::find (all(ans),v[i]);

        /*If i find v[i] in ans do ntng*/
        /*else push it to ans*/

        /*If iterator does not go till end means we have found some element*/
        /*If it goes till end means element not found*/
