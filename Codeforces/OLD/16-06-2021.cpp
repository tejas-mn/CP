...
void solve()
{
        ...
        {
                int c=1;
                //Pick the element at v[index] as the position
                int ele=v[index];

                //until that element == index(Once they become not equal come out of the loop)
                while(ele!=index)
                {
                        c+=1;
                        //Pick the element at v[element] as the next position
                        ele=v[ele];
                }
